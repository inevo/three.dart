	...
	pose() {
	  ...
	  if ( geometry.skinVerticesA == null ) {
	    ...
	    for ( var i = 0; i < geometry.skinIndices.length; i ++ ) {
	      ...
	      geometry.skinVerticesA.push( boneInverses[ indexA ].multiplyVector3( vertex ) );

	      vertex = new Vector3( orgVertex.x, orgVertex.y, orgVertex.z );
	      geometry.skinVerticesB.push( boneInverses[ indexB ].multiplyVector3( vertex ) );
