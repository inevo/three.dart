class MorphAnimMesh extends Mesh {
  ...
  updateAnimation( delta ) {
    ...
    if ( keyframe !== currentKeyframe ) {
      ...
      _morphTargetInfluences[ lastKeyframe ] = 0;
      _morphTargetInfluences[ currentKeyframe ] = 1;

      _morphTargetInfluences[ keyframe ] = 0;
    ...
    _morphTargetInfluences[ currentKeyframe ] = mix;
    _morphTargetInfluences[ lastKeyframe ] = 1 - mix;
