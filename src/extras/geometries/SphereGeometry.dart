...
{  
  ...
  SphereGeometry([num radius = 50, num segmentsWidth = 8, num segmentsHeight = 6, num phiStart = 0, num phiLength = Math.PI * 2, num thetaStart = 0, num thetaLength = Math.PI * 2]) : super() {
