...
class Shape extends Path {
  ...
  getPointsHoles( divisions ) {
  	...
  	var i, il = _holes.length, holesPts = [];
  
  	for ( i = 0; i < il; i ++ ) {
  
  		holesPts[ i ] = _holes[ i ].getTransformedPoints( divisions, _bends );
  ...
  getSpacedPointsHoles ( divisions ) {
  	...
  	for ( i = 0; i < il; i ++ ) {
  		...
  		holesPts[ i ] = _holes[ i ].getTransformedSpacedPoints( divisions, _bends );
